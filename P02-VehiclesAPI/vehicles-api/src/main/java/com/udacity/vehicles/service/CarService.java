...
public class CarService {
    ...
    private static final String CAR_DOES_NOT_EXIST = "Car does not exist !";
    ...
    public Car findById(Long id) throws CarNotFoundException {
        try {
            ...
            return car;
        } catch (CarNotFoundException carNotFoundEx) {
            throw new CarNotFoundException(CAR_DOES_NOT_EXIST);
        }
    }
